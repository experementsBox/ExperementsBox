...
function pasteExperement(elem){
    ...
    h.innerHTML = sourcefile[elem]["title"];
    maininfoelem.innerHTML = " ";
    maininfoelem.appendChild(h);
    maininfoelem.innerHTML += sourcefile[elem]["text"];
}